...
DOTNET_RISCV_VERSION="10.0.112"
DOTNET_RISCV_BASE="https://github.com/autorepobot/dotnet-riscv/releases/download"
...
' riscv64 ;;
      ...
      ;;
    *)
      echo "Unknown --arch '${ARCH_OVERRIDE}'. Use riscv64|all." >&2
      return 1
      ;;
  esac
}
