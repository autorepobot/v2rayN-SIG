...
DOTNET_TFM="net10.0"
DOTNET_LOONGARCH_VERSION="10.0.112"
DOTNET_LOONGARCH_TAG="v10.0.112-loongarch64"
...
%s
%s
' "linux-loongarch64" "loong64" "loong64" ;;
...
' loongarch64 ;;
      ...
      ;;
    *)
      echo "Unknown --arch '${ARCH_OVERRIDE}'. Use loongarch64|all." >&2
      return 1
      ;;
  esac
}
